...
public class DiaBreak {
	    ...
	    public boolean asignarCita(int hora, Cita cita)
	    {
	        if(validaHora(hora) && huecoLibre(hora, cita.getDuracion())) {
	            ...
	            /*
	             * He encontrado un error al comprobar citas[this.numeroDia] 
	             * ya que no se debe comprobar sobre el numero de dia, si no por 
	             * la hora inicial. @Test AsignarCita
	            */
	    ...
	    public String muestraCita(int hora){      
	    	...
	    	if (validaHora(hora)) { 
	    		...
	    		//Fallo en el string "Hora Valida" -> Hora no valida
	    		//encontrado en @Test MuestraCita
